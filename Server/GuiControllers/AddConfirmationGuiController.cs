...
namespace Server.GuiControllers
{
    public class AddConfirmationGuiController
        ...
        internal void ShowFrmAddConfirmation(Bibliotekar bibliotekar)
        {
            ...
            frmAddConfirmation.CboxUser.DataSource = Controller.Instance.GetAllUsers();
            frmAddConfirmation.CboxUser.DisplayMember = "Ime";
            frmAddConfirmation.CboxBook.DataSource = Controller.Instance.GetAllBooks();
        ...
        internal void AddConfirmation(object sender, EventArgs e)
        {
            ...
            if (Controller.Instance.SaveConfirmation(potvrda))
            {
                MessageBox.Show("Uspesno dodata potvrda", "Uspjeh", MessageBoxButtons.OK, MessageBoxIcon.Information);
